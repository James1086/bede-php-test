<?php
	...
	$success = false;
 	$casinoname=$_POST['addcasinoname']; 
	$casinolocation=$_POST['addcasinolocation'];
	$casinoopening=$_POST['addcasinoopening'];
	...
	if( check_uk_postcode($casinolocation) == 'valid' ){
		$sql = "INSERT INTO casinos ( name, location, opening ) VALUES ( '$casinoname', '$casinolocation', '$casinoopening' )";
